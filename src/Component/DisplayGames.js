...
const handleClick=async()=>{
  ...
  {
  var body = {"gameid":gameid,"gamename":gameName,"description":description,"price":price,"stock":stock,"rented":rented,"rentamt":rentamt,"offer":offer}
    ...
    <div className={classes.root}>
        ...
        >
            {fillSubCategory()}
                ...
                <Grid item xs={12} sm={4}>
                    <TextField label="Game Name" value={gameName} onChange={(event)=>setGameName(event.target.value)} variant="outlined" fullWidth/>
                </Grid>
        ...
        modules={DisplayGames.modules}
        formats={DisplayGames.formats}
        onChange={(value) => setDescription(value)} />
                ...
                <span style={{fontSize:15,fontWeight:400}}>Edit Game Picture</span>
...
function DisplayAll() {
  ...
  return(<div style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
    <div style={{marginTop:40, padding:5, width:1120}}>
      {DisplayAll()}
    </div>
  </div>)
}

...
////////////////////////////////////////////Multiple Picture Uploader////////////////////////////////////////////////////
  ...
  const handleClick =async() => {
    ...
    var result = await postDataAndImage('accessorypicture/addnewaccessorypicture',formData, config)
    if(result)
    {
        swal({
            title: "Accessory Picture Submitted Successfully",
            icon: "success",
            dangerMode: true,
           })
    }
    ...
    return (
        ...
        >
            ...
            {showSubCategory()}
                    ...
                    <Grid item xs={12} sm={4}>
                    <FormControl variant="outlined" className={classes.formControl} fullWidth>
        <InputLabel id="demo-simple-select-outlined-game">Accessory</InputLabel>
        <Select
          labelId="demo-simple-select-outlined-game"
        ...
        >
            ...
            {showAccessory()}
                   ...
                   {/*<Grid item xs={6}>
                    <span style={{fontSize:15,fontWeight:400}}>Upload Accessory Icon</span>

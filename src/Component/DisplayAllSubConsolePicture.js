...
export default function DisplayAllSubConsolePicture(props)
{ 
...
const handledelete=async()=>{
  ...
  var result = await postData('subconsolepicture/deletesubconsolepicture',body);

  if(result)
  {
      swal({
          title: "Sub Console Picture Deleted Successfully",
          icon: "success",
          dangerMode: true,
         })
  }
...
const handleClick=async()=>{
  ...
  var result = await postData('subconsolepicture/editsubconsolepicturedata',body);
  }
  if(result)
  {
      swal({
          title: "SubConsole Updated Successfully",
          icon: "success",
          dangerMode: true,
         })
  }
...
const handleClickSaveIcon=async()=>{
  ...
  var result = await postDataAndImage('subconsolepicture/editicon',formData, config)
  if(result)
  {
      swal({
...
const editFormView=()=>{
    ...
    <div className={classes.root}>
        ...
        >
            {fillSubCategory()}
                ...
                <Grid item xs={12} sm={6}>
                <span style={{fontSize:15,fontWeight:400}}>Edit SubConsole Picture</span>
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              ...
              <Typography variant="h6" className={classes.title}>
                Edit/Delete SubConsole Picture
              </Typography>
  ...
  const fetchAllSubConsolePicture=async()=>{
    var result = await getData('subconsolepicture/Displaysubconsolepicture')
    setList(result)
  }
  useEffect (function(){
    fetchAllSubConsolePicture()
...
function DisplayAll() {
    return (
      <div>
      <MaterialTable
        title="Sub Console Picture List"
        columns={[
        ...
        actions={[
          {
            icon: 'editoutlined',
            tooltip: 'Edit SubConsole Picture',

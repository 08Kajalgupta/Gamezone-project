...
////////////////////////////////////////////Multiple Picture Uploader////////////////////////////////////////////////////
  ...
  const handleClick =async(data) => {
    ...
    var result = await postDataAndImage('gamespicture/addnewgamespicture',formData, config)
    if(result)
    {
        swal({
            title: "Game Picture Submitted Successfully",
            icon: "success",
            dangerMode: true,
           })
    }
    ...
    return (
        ...
        >
            ...
            {showSubCategory()}
                    ...
                    <Grid item xs={12} sm={4}>
                    <FormControl variant="outlined" className={classes.formControl} fullWidth>
        <InputLabel id="demo-simple-select-outlined-game">Game</InputLabel>
        <Select
